...
<body>
    <div class="container text-center">
        ...
        <div class="d-grip gap-2">
            ...
            <a class="btn btn-primary btn-lg" href="profesores/listar_profesores.php">Profesores</a>
            <a class="btn btn-primary btn-lg" href="curso/listar_curso.php">Cursos</a>
            <a class="btn btn-primary btn-lg" href="inscripciones/listar_inscripciones.php">Inscripciones</a>
